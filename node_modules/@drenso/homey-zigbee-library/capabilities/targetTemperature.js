...
async function initTargetTemperatureDevice(device, zclNode, { capabilityId = 'target_temperature', cluster = zigbee_clusters_1.CLUSTER.THERMOSTAT, attributeName = 'occupiedHeatingSetpoint', minChange = 10, minInterval, maxInterval, endpointId, } = {}) {
    ...
    }, (value) => Math.round(value * 100), { minChange, minInterval, maxInterval }, endpointId);
}
