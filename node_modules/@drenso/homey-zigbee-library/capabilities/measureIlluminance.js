...
async function initMeasureIlluminanceDevice(device, zclNode, { capabilityId = 'measure_luminance', cluster = zigbee_clusters_1.CLUSTER.ILLUMINANCE_MEASUREMENT, attributeName = 'measuredValue', minChange = 1000, minInterval, maxInterval, endpointId, } = {}) {
    ...
    }, { minInterval, maxInterval, minChange }, endpointId);
}
